...
var calendar = function(calendarId){
    ...
    c.init = function(){
        ...
        loadStyles(".calendarDiv {width:201px;text-align:center;}\
            .Table{width:200px;height:200px;}\
            .box{margin-left:15px;margin-right:10px;text-align:center;width:175px;height:22px;font-weight:bold;font-size:21px;}\
