...
<hr><br/>
 ...
 <!-- <div class="col-md-1"></div> -->
  ...
  <form class="form-horizontal" action="${basePath}teacher/updateUser.do" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="userPhone" name="userPhone"
        onkeyup="isTel()"  value="${user.userPhone}" maxlength="11">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="email" name="email"
     onkeyup="isemail()"  value="${user.email}">
