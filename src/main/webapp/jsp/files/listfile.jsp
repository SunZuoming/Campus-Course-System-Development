    ...
    <body>
        <div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>首页</cite></a>
              <a><cite>文件审核管理</cite></a>
            </span>
            <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"  href="javascript:location.replace(location.href);" title="刷新"><i class="layui-icon" style="line-height:30px">ဂ</i></a>
        </div>
        <div class="x-body">
            <form action = "${pageContext.request.contextPath}/file/filelist" method="get" layui-form x-center" action="" style="width:500px">
            ...
            <%-- <button class="layui-btn" ><a href="${pageContext.request.contextPath}/role/addquanxian.do" ><i class="layui-icon">&#xe608;</i>添加</a></button>
            <button class="layui-btn" ><a href="${pageContext.request.contextPath}/role/getuser.do" ><i class="layui-icon">&#xe608;</i>用户管理</a></button> --%>
            ...
            <table class="layui-table">
               ...
               <span class="x-right" style="line-height:25px">共有数据：${count } 条</span>
                <c:forEach items="${list}" var="s">
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" value="${s.sharedfileno } " name="deleteCheckBox" >
                        </td>
                        <td id="record">
                           ${s.sharedfilename} 
                        </td>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="查看" href="${pageContext.request.contextPath}/file/fileCheck.do?id=${s.sharedfileno}" onclick="role_management_look('查看','role_management_look.html','4','','510')"
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon"><img src="${basePath}images/look3.png" width="15" height="15"></i>
                            </a>
                            <%-- <a title="删除" type="button" href="${pageContext.request.contextPath}/role/delete.do?id=${s.sharedfileno}" onclick="submit()" 
        ...
        function BatchOperate(){
            ...
            var checkBoxArray=[]; 
             ...
             $.ajax({ 
                 type : 'post', 
                 url : '${pageContext.request.contextPath }/role/deleteMap', 
