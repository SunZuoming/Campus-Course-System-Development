...
<div class="col-md-7 col-lg-7 col-lg-offset-3 col-md-offset-3">
    ...
    <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
        <form id="monthReportForm" action="${basePath }pages/admin/monthReport.do" method="post">
            <div class="panel-heading templatemo-position-relative panel-info">
                <h2 class=" text-center text-primary">月操作统计报表</h2>
            </div>
            <div class="panel-body">
                <div class="col-md-12 col-lg-12">
                    <div class="col-lg-8 col-md-8">
                        ...
                        <div class="col-lg-4 col-md-4 text-left">
                            <input type="text" name="startDate" id="startDate" placeholder="选择该月任意一天代表该月">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="col-lg-8 col-md-8">
                        ...
                        <div class=" col-lg-4 col-md-4 text-left">
                            <input type="text" name="endDate" id="endDate" placeholder="结束月份应大于开始月份">
                        </div>
