...
<div class="col-md-7 col-lg-7 col-lg-offset-3 col-md-offset-3">
    ...
    <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
        <form id="dayReportForm" action="${basePath }pages/admin/dayReport.do" method="post">
            <div class="panel-heading templatemo-position-relative panel-info">
                <h2 class=" text-center text-primary">日操作统计报表</h2>
            </div>
            <div class="panel-body">
                <div class="col-md-12 col-lg-12">
                    <div class="col-lg-8 col-md-8">
                        ...
                        <div class="col-lg-4 col-md-4 text-left">
                            <input type="text" name="startDate" id="startDate" placeholder="开始日期应在今日之前">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="col-lg-8 col-md-8">
                        ...
                        <div class=" col-lg-4 col-md-4 text-left">
                            <input type="text" name="endDate" id="endDate" placeholder="结束日期应大于开始日期">
                        </div>
